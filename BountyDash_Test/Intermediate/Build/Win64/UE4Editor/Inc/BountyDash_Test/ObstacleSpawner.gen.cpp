...
#include "BountyDash_Test/ObstacleSpawner.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	BOUNTYDASH_TEST_API UClass* Z_Construct_UClass_AObstacleSpawner_NoRegister();
	BOUNTYDASH_TEST_API UClass* Z_Construct_UClass_AObstacleSpawner();
...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FClassPropertyParams NewProp_ObstacleToSpawn_Inner;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ObstacleToSpawn_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_ObstacleToSpawn;
...
#endif
	const UE4CodeGen_Private::FClassPropertyParams Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn_Inner = { "ObstacleToSpawn", nullptr, (EPropertyFlags)0x0004000000000000, UE4CodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_AObstacle_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn_MetaData[] = {
		{ "Category", "ObstacleSpawner" },
		{ "ModuleRelativePath", "ObstacleSpawner.h" },
	};
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn = { "ObstacleToSpawn", nullptr, (EPropertyFlags)0x0014000000000005, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AObstacleSpawner, ObstacleToSpawn), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn_MetaData)) };
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AObstacleSpawner_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn_Inner,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AObstacleSpawner_Statics::NewProp_ObstacleToSpawn,
	...
	IMPLEMENT_CLASS(AObstacleSpawner, 1480942356);
	template<> BOUNTYDASH_TEST_API UClass* StaticClass<AObstacleSpawner>()
	{
		return AObstacleSpawner::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AObstacleSpawner(Z_Construct_UClass_AObstacleSpawner, &AObstacleSpawner::StaticClass, TEXT("/Script/BountyDash_Test"), TEXT("AObstacleSpawner"), false, nullptr, nullptr, nullptr);
