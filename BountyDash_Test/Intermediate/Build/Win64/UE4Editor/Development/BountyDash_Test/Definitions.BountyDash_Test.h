...
#define UE_PROJECT_NAME BountyDash_Test
#define UE_TARGET_NAME BountyDash_TestEditor
#define UE_MODULE_NAME "BountyDash_Test"
...
#define BOUNTYDASH_TEST_API DLLEXPORT
